...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> _ar = {
    ...
    "onboard": {
      ...
      "desc_3":
          "أقرب الصيدليات، معامل التحاليل، ومراكز الأشعة كلها في مكان واحد."
    },
    "search_page": {
    ...
    "cart": {"title": "السلة", "make_payment": "ادفع دلوقتي"},
    "appointment": {
      "title": "مواعيدي",
      "upcoming": "اللي جاية",
      "completed": "اللي خلصت",
    ...
    "auth": {
      ...
      "error_need_verification":
          "حسابك قيد المراجعة من الإدارة. يرجى الانتظار حتى يتم تفعيل حسابك.",
      "reset_email_sent":
  ...
  static const Map<String, dynamic> _en = {
    ...
    "reminder": {
      ...
      "medication_added_success":
          "Medication added and reminder scheduled successfully!",
    ...
    "cart": {"title": "Cart", "make_payment": "Make Payment"},
    "appointment": {
      "title": "Appointments",
      "upcoming": "Upcoming",
      "completed": "Completed",
      ...
      "cancel_confirm_msg":
          "Are you sure you want to cancel appointment of Dr. {doctorName}?",
      "cancel_success_title": "Canceled Successfully",
      "cancel_success_msg":
          "Your appointment with Dr. {doctorName} is canceled successfully",
    ...
    "auth": {
      ...
      "reset_email_sent":
          "Reset Password Email Sent Successfully, check your email to reset your password",
