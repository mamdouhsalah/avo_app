...
class CodegenLoader extends AssetLoader{
  ...
  "scanner": {
    "image_source": "Choose Image Source",
    "take_photo": "Take Photo for Analysis",
    "take_new_photo": "Capture new photo",
    "choose_gallery": "Choose from Gallery",
    "choose_gallery_sub": "Select photo from gallery",
    "tap_scan": "Tap to scan analysis photo",
    ...
    "medical_analysis": "Medical Text Analysis",
    ...
    "camera_permission_denied": "Please grant camera permission from settings",
    "image_pick_error": "Error picking image: {}",
    "no_text_recognized": "No text recognized in the image.",
    "text_extract_failed": "Failed to extract text: {}",
    "analysis_saved_successfully": "Analysis saved successfully ✅",
    "data_save_failed": "Failed to save data: {}",
    "uploading_image": "Uploading image to cloud, please wait...",
    "extracted_text_label": "Extracted Text",
    "analysis_label": "Analysis",
    "default_analysis_name": "Analysis",
    "analysis_results_state": "Analysis Results"
    "january": "يناير",
    "february": "فبراير",
    "march": "مارس",
    "april": "أبريل",
...
static const Map<String,dynamic> _en = {
  ...
  "scanner": {
    ...
    "take_photo": "التقط صورة للتحليل",
    "take_new_photo": "التقط صورة جديدة",
    "choose_gallery": "اختر من المعرض",
    "choose_gallery_sub": "اختر صورة من المعرض",
    "tap_scan": "اضغط لمسح صورة التحليل",
    "camera_or_gallery": "(كاميرا أو معرض الصور)",
    "camera": "الكاميرا",
    "gallery": "المعرض",
    "new_photo": "صورة جديدة",
    "save_analysis": "حفظ التحليل",
    "saved_success": "تم الحفظ بنجاح",
    "medical_analysis": "تحليل نصوص طبية",
    "analysis_failed": "حدث خطأ أثناء التحليل بالذكاء الاصطناعي. يمكنك حفظ النص المستخرج يدوياً.",
    "analysis_failed_quota": "فشل التحليل الذكي (Quota Exceeded أو مشكلة اتصال).\n\nالنص المستخرج من الصورة:\n{}",
    "storage_not_ready": "التخزين غير جاهز بعد، يرجى الانتظار...",
    "gemini_prompt": "أنت مساعد طبي، قم بتحليل النص المستخرج التالي باللغة العربية العامية: {}. هام جداً: إذا كان النص لا يمت بصلة للتحاليل الطبية أو نتائج المختبر أو الروشتات أو الرعاية الصحية، ارفض الإجابة بلطف وأخبر المستخدم أنك تقوم بتحليل المستندات الطبية فقط. وإلا، اشرح النتائج ببساطة ووضوح ووجه المريض للتخصص المناسب.",
    "analysis_name": "اسم التحليل",
    "type_file_name": "اكتب اسم الملف...",
    "extracted_text": "النص المستخرج:\n{}",
    "storage_init_failed": "فشل في تهيئة التخزين: {}",
    "camera_permission_denied": "يرجى منح إذن الكاميرا من الإعدادات",
    "image_pick_error": "خطأ في اختيار الصورة: {}",
    "no_text_recognized": "لم يتم التعرف على أي نص في الصورة.",
    "text_extract_failed": "فشل استخراج النص: {}",
    "analysis_saved_successfully": "تم حفظ التحليل بنجاح ✅",
    "data_save_failed": "فشل حفظ البيانات: {}",
    "uploading_image": "جاري رفع الصورة السحابية، برجاء الانتظار...",
    "extracted_text_label": "النص المستخرج",
    "analysis_label": "التحليل",
    "default_analysis_name": "تحليل",
    "analysis_results_state": "نتائج التحليل"
    "january": "January",
    "february": "February",
    "march": "March",
    "april": "April",
